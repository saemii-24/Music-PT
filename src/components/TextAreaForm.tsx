  ...
  return (
    <>
      ...
      <div className='mt-6 flex items-center justify-center gap-x-6'>
        ...
        <button
          type='submit'
          className='rounded-md bg-music-blue px-3 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-music-lightblue bfocus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600'>
