  ...
  return (
    <svg
      ...
      <rect
        ...
        height='47.4231'
        rx='3.51282'
        transform='rotate(-180 323.57 198.724)'
        className='fill-[#ffffff] dark:fill-[#9A9EAD]'
      />
      <rect
        x='307.763'
        ...
        height='29.859'
        rx='3.51282'
        transform='rotate(-180 307.763 189.942)'
        className='fill-[#ffffff] dark:fill-[#9A9EAD]'
      />
      <rect
        x='291.955'
        ...
        height='35.1282'
        rx='3.51282'
        transform='rotate(-180 291.955 192.577)'
        className='fill-[#ffffff] dark:fill-[#9A9EAD]'
      />
      <rect
        x='277.025'
        ...
        height='24.5897'
        rx='3.51282'
        transform='rotate(-180 277.025 187.308)'
        className='fill-[#ffffff] dark:fill-[#9A9EAD]'
      />
      <circle
        cx='175'
      ...
      />
      <path
        d='M204.072 186.43C204.072 176.726 204.072 168.383 204.072 164.713C204.072 163.608 204.97 162.709 206.071 162.801C218.231 163.816 227.783 174.007 227.783 186.43C227.783 198.852 218.231 209.043 206.071 210.058C204.97 210.15 204.072 209.251 204.072 208.146C204.072 204.476 204.072 196.133 204.072 186.43Z'
        className='fill-[#ffffff] dark:fill-[#9A9EAD]'
      />
      <rect
        x='201.346'
        ...
        height='47.4231'
        rx='3.51282'
        transform='rotate(-180 201.346 210.141)'
        className='fill-[#ffffff] dark:fill-[#9A9EAD]'
      />
    </svg>
  );
