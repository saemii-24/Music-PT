  ...
  return (
    <section className='animate-pulse dark:bg-music-background'>
      <div className=' container grid grid-cols-4 lg:grid-cols-6 2xl:grid-cols-7 '>
        {/* 이미지 */}
        <div className='relative col-span-4 aspect-square  overflow-hidden rounded-lg bg-music-skeleton transition after:absolute after:left-0 after:top-0  after:z-10 after:size-full after:bg-black after:opacity-0 after:transition after:content-[""]  lg:col-span-2 lg:row-span-6 lg:mr-20'></div>
        {/* 좋아요 */}
        <div className='col-span-4 mb-[0.4rem] mt-5 w-[50px]  rounded-md bg-music-skeleton md:col-span-3'>
          &nbsp;
        </div>
